...
class WarrantyCard(models.Model):
    ...
    distribuidor = fields.Char(string="Distribuidor")
    ...
    #dates = datetime.strptime(fecha_string,"%d-%m-%Y")
    #day = str(dates.day)
    ...
    #modelo = fields.Many2one('res.partner', string='Modelo', related='requests_id.modelo')
