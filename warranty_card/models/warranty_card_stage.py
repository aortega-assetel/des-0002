...
class WarrantyCardStage(models.Model):
    _name = 'warranty.card.stage'
    _description = 'Etapas de modelo Tarjetas de Garantías'
    _order = 'sequence, id'
    ...
    mail_template_id = fields.Many2one(
        'mail.template', 'Plantilla de correo electrónico', domain="[('model', '=', 'warranty.card')]",
